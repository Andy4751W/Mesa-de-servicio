...
function seguridadAplicarCabeceras(bool $contenidoPrivado = true): void
{
    ...
    /*
     * Los portales por pais conservan su navegacion y abren los modulos
     * dentro de un marco del mismo sitio. SAMEORIGIN mantiene la proteccion
     * contra iframes externos y permite esa composicion interna.
     */
