...
if ($idTicketPrueba > 0) {
    try {
        ...
        $stmt->bind_param('ii', $idTicketPrueba, $idPaisOperacion);
        $stmt->execute();
...
<head>
    ...
    <style>
        :root{--navy:#102a43;--primary:#0f6fec;--muted:#526d82;--line:#dce6f2;--bg:#f3f7fc;--ok:#087f5b;--warn:#b45309}
