...
$sql = "
    SELECT
        ...
        t.tipo_solicitud, t.urgencia, t.prioridad,
        ...
        COALESCE(pais_solicitante.nombre, 'Sin asignar') AS solicitante_pais,
        COALESCE(departamento_solicitante.nombre, 'Sin asignar') AS solicitante_departamento,
        COALESCE(ciudad_solicitante.nombre, NULLIF(solicitante.ciudad, ''), 'Sin asignar') AS solicitante_ciudad,
    ...
    LEFT JOIN configuraciones_servicio AS pais_solicitante
        ON pais_solicitante.id_opcion = solicitante.id_pais
       AND pais_solicitante.tipo = 'pais'
    LEFT JOIN configuraciones_servicio AS departamento_solicitante
        ON departamento_solicitante.id_opcion = solicitante.id_departamento
       AND departamento_solicitante.tipo = 'departamento'
    LEFT JOIN configuraciones_servicio AS ciudad_solicitante
        ON ciudad_solicitante.id_opcion = solicitante.id_ciudad
       AND ciudad_solicitante.tipo = 'ciudad'
...
$encabezados = [
    'ID ticket', 'Estado general', 'Estado del flujo', 'Flujo asignado',
    'Descripción del flujo', 'Clasificación', 'Título', 'Descripción', 'Urgencia',
    ...
    'Correo solicitante', 'Descripción CU1 solicitante', 'País solicitante',
    'Departamento solicitante', 'Ciudad solicitante',
...
while ($ticket = $resultado->fetch_assoc()) {
    ...
    $filas[] = [
        ...
        etiquetaExcelSolicitud($ticket['tipo_solicitud'] ?? 'requerimiento'),
        ...
        (string) ($ticket['solicitante_pais'] ?? 'Sin asignar'),
        (string) ($ticket['solicitante_departamento'] ?? 'Sin asignar'),
