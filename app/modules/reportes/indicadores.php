...
<main class="shell">
    ...
    <section class="dashboard">
        ...
        <article class="card donut-card-wide"><div class="card-head"><h2>Tickets por tipo</h2><span>Tipos con mayor demanda</span></div><div class="card-body donut-layout">
