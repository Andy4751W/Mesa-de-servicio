...
$esPeru = paisContextoCodigo() === 'PE';
$color = $esPeru ? '#c81e3a' : '#1167d8';
$colorOscuro = $esPeru ? '#8f1027' : '#072b58';
    ...
    <section class="profile-card" aria-labelledby="titulo-perfil">
        ...
        <div class="profile-body">
            <form class="photo-form" method="post" enctype="multipart/form-data">
                ...
                <p class="photo-role"><?= escaparPerfil($rolNombre) ?> · <?= escaparPerfil(paisContextoNombre()) ?></p>
