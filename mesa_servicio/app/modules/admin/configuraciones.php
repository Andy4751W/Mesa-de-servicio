...
function redirigirConfiguracion(
    ...
    header('Location: configuraciones.php?' . http_build_query($parametros));
    exit;
}
...
$tiposConfiguracion = [
    ...
    'ciudad' => [
        'plural' => 'Ciudades',
        'singular' => 'Ciudad',
        'descripcion' => 'Registre las ciudades asociadas a cada país.',
        'codigo' => 'CI',
        'color' => '#8b5cf6',
        'suave' => '#f3efff',
        'padre' => 'pais',
    ...
    'lugar' => [
        'plural' => 'Lugares',
        'singular' => 'Lugar',
        'descripcion' => 'Registre clientes, sedes o filiales de cada ciudad.',
        'codigo' => 'LU',
        'color' => '#9333ea',
        'suave' => '#f5eafe',
        'padre' => 'ciudad',
    ...
    'departamento' => [
        ...
        'descripcion' => 'Registre las áreas de sus clientes, sedes o filiales.',
        'codigo' => 'DE',
        'color' => '#6d28d9',
        'suave' => '#eee9fe',
        'padre' => 'lugar',
    ...
    try {
        if ($accion === 'crear' || $accion === 'editar') {
            ...
            if ($tipoPadre !== null) {
                ...
                $stmtPadre->bind_param('is', $idPadre, $tipoPadre);
                $stmtPadre->execute();
        ...
        if ($accion === 'estado') {
            ...
            $stmt->bind_param('sis', $nuevoEstado, $idOpcion, $tipo);
            $stmt->execute();
            $stmt->close();
...
$mensajes = [
    ...
    'opcion_eliminada' => [
        'exito',
        'La opción fue eliminada. Sus asignaciones en servicios se limpiaron.'
    ],
    'opcion_duplicada' => [
        'error',
...
if ($moduloInstalado) {
    ...
    if ($tipoPadreActual !== null) {
        ...
        $stmt->bind_param('s', $tipoPadreActual);
        $stmt->execute();
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .hero {
            ...
            box-shadow: 0 18px 42px rgba(15,111,236,.19);
        }
        ...
        .hero h1 { margin: 0; font-size: clamp(29px,4vw,42px); letter-spacing: -.035em; }
        .hero p { max-width: 680px; margin: 13px 0 0; color: rgba(255,255,255,.82); line-height: 1.6; }
                                ...
                                <tr data-search="<?= escaparConfiguracion(strtolower($opcion['nombre'] . ' ' . $opcion['descripcion'] . ' ' . ($opcion['nombre_padre'] ?? ''))) ?>">
                                    ...
                                    <td>
                                        <div class="row-actions">
                                            ...
                                            <form
                                                method="POST"
                                                onsubmit="return confirm('¿Eliminar esta opción? Las asignaciones existentes en los servicios quedarán vacías.');"
                                            >
                                                <input type="hidden" name="csrf_token" value="<?= escaparConfiguracion($_SESSION['csrf_token']) ?>">
