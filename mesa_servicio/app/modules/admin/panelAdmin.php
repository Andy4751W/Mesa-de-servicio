...
$modulosConfigurables = [
  ...
  [
    'tipo' => 'ciudad',
    'titulo' => 'Ciudades',
    'descripcion' => 'Administre las ciudades asociadas a cada país.',
    'codigo' => 'CI',
    'color' => '#8b5cf6',
    'suave' => '#f3efff',
  ],
  [
    'tipo' => 'lugar',
    'titulo' => 'Lugares',
    'descripcion' => 'Registre clientes, sedes o filiales por ciudad.',
    'codigo' => 'LU',
    'color' => '#9333ea',
    'suave' => '#f5eafe',
  ],
  [
    ...
    'descripcion' => 'Administre las áreas de cada sede o filial.',
    'codigo' => 'DE',
    'color' => '#6d28d9',
    'suave' => '#eee9fe',
  ],
  ...
  <style>
    ...
    * {
    ...
    .logout-button:focus-visible {
      outline: 3px solid rgba(159, 41, 54, 0.18);
      outline-offset: 2px;
    }
  ...
  <main class="page-shell">
    ...
    <section class="hero" aria-labelledby="titulo-panel">
      <div class="hero-content">
        ...
        <h1 id="titulo-panel">Panel de Administrador</h1>
        <p>
          Administre los usuarios, el catálogo de servicios, los tickets
          y cada parámetro operativo desde un solo lugar.
        </p>
      </div>
    </section>
