...
$obligatorios = [
    ...
    APP_ROOT . '/core/pais.php',
    APP_ROOT . '/core/ubicacion.php',
    APP_ROOT . '/modules/admin/panelAdminPeru.php',
    PROJECT_ROOT . '/database/install/001_base_mesa_servicio_limpia.sql',
    PROJECT_ROOT . '/database/migrations/004_seguridad.sql',
    PROJECT_ROOT . '/database/migrations/005_separacion_colombia_peru.sql',
    PROJECT_ROOT . '/database/migrations/006_jerarquia_pais_departamento_ciudad.sql',
